...
vscode-utils.buildVscodeMarketplaceExtension {
  mktplcRef = {
    ...
    version = "1.24.0";
    sha256 = "qS9LbLWGBkQ6qXagCI8PvyccRT4guI0E9kY7yQqQVh4=";
  };
  ...
  postPatch = ''
    ...
    declare bundled_dir="$PWD/.bundled"
    mkdir $bundled_dir

    declare omnisharp_dir="$PWD/${omnisharp.installPath}"
    mv $omnisharp_dir $bundled_dir/
